...
|数据类型|存储空间|范围|说明|
|:-:|-|-|-|
|DATE|3字节|范围：'1000-01-01' ~ '9999-12-31'；格式为：'YYYY-MM-DD'|...|
...
|DATETIME[(fsp)]|8字节（< MySQL 5.6.4） 或者 5 字节 + fractional seconds storage （>= MySQL 5.6.4） |范围：'1000-01-01 00:00:00.000000' ~ '9999-12-31 23:59:59.999999'；格式为：'YYYY-MM-DD HH:MM:SS[.fraction]'|...|
|TIMESTAMP[(fsp)]|4字节（< MySQL 5.6.4） 或者 4 字节 + fractional seconds storage（>= MySQL 5.6.4）|范围：'1970-01-01 00:00:01.000000' UTC ~ '2038-01-19 03:14:07.999999' UTC；从epoch ('1970-01-01 00:00:00' UTC)纪元开始计算的秒数|...|
|YEAR[(2\|4)]|1字节|范围：4位格式：1901 ~ 2155, 和 0000；2位格式： 70 ~ 69（1970 to 2069）、00 ~ 69（2000 ~ 2069）；格式：YYYY or YY |...|
